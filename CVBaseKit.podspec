Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/weixhe/CVBaseKit.git", :tag => "1.0.11" }         #存储库的git地址，以及tag值
  # s.source_files =  "CVBaseKit/**/*.{swift, plist}" #需要托管的源代码路径
  s.requires_arc = true #是否支持ARC

  #  组件Global
  s.subspec 'Global' do |gs|
  	gs.source_files = "CVBaseKit/Global/Global.swift" #需要托管的源代码路径	
  end
