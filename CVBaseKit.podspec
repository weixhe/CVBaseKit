Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/weixhe/CVBaseKit.git", :tag => "1.1.3" }         #存储库的git地址，以及tag值
  ...
  s.subspec 'Components/CVTabBarController' do |ts|
    ts.source_files = "Classes/Components/CVTabBarController/*.{swift}"   # 需要托管的源代码路径
  end
