Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/weixhe/CVBaseKit.git", :tag => "1.1.5" }         #存储库的git地址，以及tag值
  # s.source_files =  "Classes/**/*.{swift, plist}" #需要托管的源代码路径
  s.requires_arc = true #是否支持ARC

  #  组件Global
  s.subspec 'Global' do |ss|
  	ss.source_files = "Classes/Global/CVConst.swift"     # 需要托管的源代码路径	
  end

  #  组件Device
  s.subspec 'CVDevice' do |ss|
  	ss.source_files = "Classes/CVDevice/*.{swift, plist}"    # 需要托管的源代码路径
  ...
  s.subspec 'Components' do |ss|
    ss.subspec 'CVTabBarController' do |sss|
      sss.source_files = "Classes/Components/CVTabBarController/*.{swift}"   # 需要托管的源代码路径
    end
  end
